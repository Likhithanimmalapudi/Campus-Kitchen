...
def create_login_frames():
    ...
    img1 = Image.open(r"C:\Users\bhavana\Downloads\chef.png")
    ...
    img2 = Image.open(r"C:\Users\bhavana\Downloads\student1.png")
...
def open_week_selection(user_id):
    ...
    week_title = Label(week_window,text = "Select Week day",font=("Goudy old style", 45, "bold"), fg="#d25d17", bg="Lavender")
    ...
    tuesday_btn = Button(week_window, text="Tuesday",font=("Goudy old style", 15, "bold"), bg='indigo', width=23, height=5, command=lambda: open_secondmenu(user_id,"Tuesday"))
    ...
    friday_btn = Button(week_window, text="Friday",font=("Goudy old style", 15, "bold"),bg='orange', width=23, height=5, command=lambda: open_firstmenu(user_id,"Friday"))
...
def open_firstmenu(user_id, selected_week):
    ...
    Idly_Dosa = Radiobutton(breakfastFrame, text="Idly_Dosa", font=("Arial", 10), indicatoron=0, variable=var1,
                            value="Idly_Dosa",bg="#59C4EB", command=update_selected_items)
    ...
    Idly_BreadJam = Radiobutton(breakfastFrame, text="Idly_BreadJam", font=("Arial", 10), indicatoron=0, variable=var1,
                                value="Idly_BreadJam",bg="#bde0fe", command=update_selected_items)
    ...
    AllamRasam = Radiobutton(lunchRasam, text="AllamRasam", font=("Arial", 10), indicatoron=0, variable=var5,
                             value="AllamRasam",bg="#C3E0DD", command=update_selected_items)
    ...
    Samosachips = Radiobutton(lunchPapad, text="Samosachips", font=("Arial", 10), indicatoron=0, variable=var6,
                              value="Samosachips",bg="#FFC6C2", command=update_selected_items)
    ...
    Wheelchips = Radiobutton(lunchPapad, text="Wheelchips", font=("Arial", 10), indicatoron=0, variable=var6,
                             value="Wheelchips",bg="#FAE9DA", command=update_selected_items)
    ...
    GulabJamun = Radiobutton(dinnerSweet, text="GulabJamun", font=("Arial", 10), indicatoron=0, variable=var8,
                             value="GulabJamun",bg="#DCAAE4", command=update_selected_items)
    ...
    Watermelon = Radiobutton(dinnerFruit, text="Watermelon", font=("Arial", 10), indicatoron=0, variable=var10,
                             value="Watermelon",bg="#DCAAE4", command=update_selected_items)
...
def open_secondmenu(user_id,selected_week):
    ...
    def submit_action(id, selected_week):
        if not all([var1.get(), var2.get(), var3.get(), var4.get(), var5.get(), var6.get(), var7.get(), var8.get(),
            ...
            for widget in [Idly_Vada, Chapati_Upma, Poori_BreadJam, LemonRice, MangoRice, BreadPulav, AlooFry,
                           GerkinsFry,PaneerFry, CarrotBeetroot, PrawnsFry, FishFry, Sambar, TomatoRasam, Miriyalarasam,
                           Samosachips,Wheelchips, Chittipapad, Vegpuff, Dilpasand, CreamBun, Sweetpongal, Semiya, Kheer, PotatoFry,
                           BendiFry, CarrotFry, Watermelon, Banana, Guava, Tomato, Beerakaya, Dosakaya]:
                widget.configure(state=DISABLED)
    ...
    Chapati_Upma = Radiobutton(breakfastFrame, text="Chapati_Upma", font=("Arial", 10), indicatoron=0, variable=var1,
                               value="Chapati_Upma",bg="#F8B0B3", command=update_selected_items)
    ...
    PrawnsFry = Radiobutton(lunchCurry, text="PrawnsFry", font=("Arial", 10), indicatoron=0, variable=var4,
                            value="PrawnsFry",bg="light blue", command=update_selected_items)
    PrawnsFry.grid(row=0, column=5)
    FishFry = Radiobutton(lunchCurry, text="FishFry", font=("Arial", 10), indicatoron=0, variable=var4,
                          value="FishFry",bg="light green", command=update_selected_items)
    ...
    Sambar = Radiobutton(lunchRasam, text="Sambar", font=("Arial", 10), indicatoron=0, variable=var5, value="Sambar",
                        bg="pink", command=update_selected_items)
    Sambar.grid(row=0, column=0)
    TomatoRasam = Radiobutton(lunchRasam, text="TomatoRasam", font=("Arial", 10), indicatoron=0, variable=var5,
                              value="TomatoRasam",bg="light blue", command=update_selected_items)
    TomatoRasam.grid(row=0, column=5)
    Miriyalarasam = Radiobutton(lunchRasam, text="Miriyalarasam", font=("Arial", 10), indicatoron=0, variable=var5,
                                value="Miriyalarasam",bg="light green", command=update_selected_items)
    Miriyalarasam.grid(row=0, column=10)

    # lunchPapad
    Samosachips = Radiobutton(lunchPapad, text="Samosachips", font=("Arial", 10), indicatoron=0, variable=var6,
                              value="Samosachips",bg="pink", command=update_selected_items)
    Samosachips.grid(row=0, column=0)
    Wheelchips = Radiobutton(lunchPapad, text="Wheelchips", font=("Arial", 10), indicatoron=0, variable=var6,
                             value="Wheelchips",bg="light blue", command=update_selected_items)
    Wheelchips.grid(row=0, column=5)
    Chittipapad = Radiobutton(lunchPapad, text="Chittipapad", font=("Arial", 10), indicatoron=0, variable=var6, value="Chittipapad",bg="light green", command=update_selected_items)
    Chittipapad.grid(row=0, column=10)

    # snacks
    Vegpuff = Radiobutton(snackFrame, text="Vegpuff", font=("Arial", 12), indicatoron=0, variable=var7,value="Vegpuff",bg="#59C4EB", command=update_selected_items)
    Vegpuff.grid(row=0, column=0)
    Dilpasand = Radiobutton(snackFrame, text="Dilpasand", font=("Arial", 12), indicatoron=0, variable=var7,value="Dilpasand",bg="#bde0fe", command=update_selected_items)
    Dilpasand.grid(row=0, column=5)
    CreamBun = Radiobutton(snackFrame, text="CreamBun", font=("Arial", 12), indicatoron=0, variable=var7,
                           value="CreamBun",bg="#5ADFDF", command=update_selected_items)
    ...
    Sweetpongal = Radiobutton(dinnerSweet, text="Sweetpongal", font=("Arial", 10), indicatoron=0, variable=var8,
                              value="Sweetpongal",bg="#95b8d1", command=update_selected_items)
    Sweetpongal.grid(row=0, column=0)
    Semiya = Radiobutton(dinnerSweet, text="Semiya", font=("Arial", 10), indicatoron=0, variable=var8, value="Semiya",bg="#b8e0d2",
                         command=update_selected_items)
    Semiya.grid(row=0, column=5)
    Kheer = Radiobutton(dinnerSweet, text="Kheer", font=("Arial", 10), indicatoron=0, variable=var8, value="Kheer",bg="#eac4d5",
                        command=update_selected_items)
    Kheer.grid(row=0, column=10)
    # fry
    PotatoFry = Radiobutton(dinnerFry, text="PotatoFry", font=("Arial", 10), indicatoron=0, variable=var9,
                            value="PotatoFry",bg="#95b8d1", command=update_selected_items)
    PotatoFry.grid(row=0, column=0)
    BendiFry = Radiobutton(dinnerFry, text="BendiFry", font=("Arial", 10), indicatoron=0, variable=var9,
                           value="BendiFry",bg="#b8e0d2", command=update_selected_items)
    BendiFry.grid(row=0, column=5)
    CarrotFry = Radiobutton(dinnerFry, text="CarrotFry", font=("Arial", 10), indicatoron=0, variable=var9,
                            value="CarrotFry",bg="#eac4d5", command=update_selected_items)
    CarrotFry.grid(row=0, column=10)
    # Fruit
    Watermelon = Radiobutton(dinnerFruit, text="Watermelon", font=("Arial", 10), indicatoron=0, variable=var10,
                             value="Watermelon",bg="#95b8d1", command=update_selected_items)
    Watermelon.grid(row=0, column=0)
    Banana = Radiobutton(dinnerFruit, text="Banana", font=("Arial", 10), indicatoron=0, variable=var10, value="Banana",bg="#b8e0d2",
                         command=update_selected_items)
    Banana.grid(row=0, column=5)
    Guava = Radiobutton(dinnerFruit, text="Guava", font=("Arial", 10), indicatoron=0, variable=var10, value="Guava",bg="#eac4d5",
                        command=update_selected_items)
    Guava.grid(row=0, column=10)
    # Dal
    Tomato = Radiobutton(dinnerDal, text="Tomato", font=("Arial", 10), indicatoron=0, variable=var11, value="Tomato",bg="#95b8d1",
                         command=update_selected_items)
    Tomato.grid(row=0, column=0)
    Beerakaya = Radiobutton(dinnerDal, text="Beerakaya", font=("Arial", 10), indicatoron=0, variable=var11,
                            value="Beerakaya",bg="#b8e0d2", command=update_selected_items)
    Beerakaya.grid(row=0, column=5)
    Dosakaya = Radiobutton(dinnerDal, text="Dosakaya", font=("Arial", 10), indicatoron=0, variable=var11,
                           value="Dosakaya",bg="#eac4d5", command=update_selected_items)
    Dosakaya.grid(row=0, column=10)
...
def open_thirdmenu(user_id,selected_week):
    ...
    # breakfast
    Ravapunukulu_upma = Radiobutton(breakfastFrame, text="Ravapunukulu_upma", font=("Arial", 10), indicatoron=0,variable=var1,value="Ravapunukulu_upma",bg="#d1cfe2", command=update_selected_items)
    Ravapunukulu_upma.grid(row=0, column=0)
    Uttapam_upma = Radiobutton(breakfastFrame, text="Uttapam_upma", font=("Arial", 10), indicatoron=0, variable=var1,value="Uttapam_upma",bg="#9cadce", command=update_selected_items)
    Uttapam_upma.grid(row=0, column=5)
    Chapati_Upma = Radiobutton(breakfastFrame, text="Chapati_Upma", font=("Arial", 10), indicatoron=0,variable=var1, value="Chapati_Upma",bg="#7ec4cf", command=update_selected_items)
    Chapati_Upma.grid(row=0, column=10)

    # lunchrice
    CoconutRice = Radiobutton(lunchrice, text="CoconutRice", font=("Arial", 10), indicatoron=0, variable=var2,
                              value="CoconutRice",bg="#70d6ff", command=update_selected_items)
    CoconutRice.grid(row=0, column=0)
    Kichidi = Radiobutton(lunchrice, text="Kichidi", font=("Arial", 10), indicatoron=0, variable=var2,
                          value="Kichidi",bg="#a5ffd6", command=update_selected_items)
    Kichidi.grid(row=0, column=5)
    GonguraRice = Radiobutton(lunchrice, text="GonguraRice  ", font=("Arial", 10), indicatoron=0, variable=var2,
                              value="GonguraRice",bg="#ffa69e", command=update_selected_items)
    ...
    VankayaBatani = Radiobutton(lunchFry, text="VankayaBatani", font=("Arial", 10), indicatoron=0, variable=var3,
                                value="VankayaBatani",bg="#70d6ff", command=update_selected_items)
    VankayaBatani.grid(row=0, column=0)
    Kadipakodi = Radiobutton(lunchFry, text="Kadipokadi", font=("Arial", 10), indicatoron=0, variable=var3,bg="#a5ffd6",
                             value="Kadipakodi",
                             command=update_selected_items)
    Kadipakodi.grid(row=0, column=5)
    Soyamasala = Radiobutton(lunchFry, text="Soyamasala", font=("Arial", 10), indicatoron=0, variable=var3,
                             value="Soyamasala",bg="#ffa69e",
                             command=update_selected_items)
    Soyamasala.grid(row=0, column=10)

    # LunchCurry
    Potato = Radiobutton(lunchCurry, text="Potato", font=("Arial", 10), indicatoron=0, variable=var4, value="Potato",bg="#70d6ff",
                         command=update_selected_items)
    Potato.grid(row=0, column=0)
    Ladysfinger = Radiobutton(lunchCurry, text="Ladysfinger", font=("Arial", 10), indicatoron=0, variable=var4,
                              value="Ladysfinger",bg="#a5ffd6", command=update_selected_items)
    Ladysfinger.grid(row=0, column=5)
    Mixedveg = Radiobutton(lunchCurry, text="Mixedveg", font=("Arial", 10), indicatoron=0, variable=var4,
                           value="Mixedveg",bg="#ffa69e", command=update_selected_items)
    Mixedveg.grid(row=0, column=10)

    # LunchRasam
    Sambar = Radiobutton(lunchRasam, text="Sambar", font=("Arial", 10), indicatoron=0, variable=var5, value="Sambar",bg="#70d6ff",
                         command=update_selected_items)
    Sambar.grid(row=0, column=0)
    TomatoRasam = Radiobutton(lunchRasam, text="TomatoRasam", font=("Arial", 10), indicatoron=0, variable=var5,
                              value="TomatoRasam",bg="#a5ffd6", command=update_selected_items)
    TomatoRasam.grid(row=0, column=5)
    MiriyalaRasam = Radiobutton(lunchRasam, text="MiriyalaRasam ", font=("Arial", 10), indicatoron=0, variable=var5,
                                value="MiriyalaRasam ",bg="#ffa69e", command=update_selected_items)
    MiriyalaRasam.grid(row=0, column=10)

    # lunchPapad
    Samosachips = Radiobutton(lunchPapad, text="Samosachips", font=("Arial", 10), indicatoron=0, variable=var6,
                              value="Samosachips",bg="#70d6ff", command=update_selected_items)
    Samosachips.grid(row=0, column=0)
    Wheelchips = Radiobutton(lunchPapad, text="Wheelchips", font=("Arial", 10), indicatoron=0, variable=var6,
                             value="Wheelchips",bg="#a5ffd6", command=update_selected_items)
    Wheelchips.grid(row=0, column=5)
    Chittipapad = Radiobutton(lunchPapad, text="Chittipapad", font=("Arial", 10), indicatoron=0, variable=var6,
                              value="Chittipapad",bg="#ffa69e", command=update_selected_items)
    Chittipapad.grid(row=0, column=10)

    # snacks
    Kachori = Radiobutton(snackFrame, text="Kachori", font=("Arial", 12), indicatoron=0, variable=var7,
                          value="Kachori",bg="#ffc2d1", command=update_selected_items)
    Kachori.grid(row=0, column=0)
    FruitCake = Radiobutton(snackFrame, text="FruitCake", font=("Arial", 12), indicatoron=0, variable=var7,value="FruitCake",bg="#eaf2d7",command=update_selected_items)
    FruitCake.grid(row=0, column=5)
    Vegroll = Radiobutton(snackFrame, text="Vegroll", font=("Arial", 12), indicatoron=0, variable=var7,value="Vegroll",bg="#b3dee2", command=update_selected_items)
    Vegroll.grid(row=0, column=10)

    # Dinner
    # sweet
    BreadHalva = Radiobutton(dinnerSweet, text="BreadHalva", font=("Arial", 10), indicatoron=0, variable=var8,value="BreadHalva",bg="#ffc09f", command=update_selected_items)
    BreadHalva.grid(row=0, column=0)
    Kesari = Radiobutton(dinnerSweet, text="Kesari", font=("Arial", 10), indicatoron=0, variable=var8, value="Kesari",bg="#a0ced9", command=update_selected_items)
    Kesari.grid(row=0, column=5)
    GulabJamun = Radiobutton(dinnerSweet, text="GulabJamun", font=("Arial", 10), indicatoron=0, variable=var8, value="GulabJamun",bg="#adf7b6",command=update_selected_items)
    GulabJamun.grid(row=0, column=10)

    # icecreme
    Vannila = Radiobutton(dinnericecreme, text="Vannila", font=("Arial", 10), indicatoron=0, variable=var9,value="icecreme",bg="#ffc09f", command=update_selected_items)
    Vannila.grid(row=0, column=0)
    Strawberry = Radiobutton(dinnericecreme, text="Strawberry", font=("Arial", 10), indicatoron=0, variable=var9,value="Strawberry",bg="#a0ced9", command=update_selected_items)
    Strawberry.grid(row=0, column=5)
    ButterScotch = Radiobutton(dinnericecreme, text="ButterScotch", font=("Arial", 10), indicatoron=0, variable=var9, value="ButterScotch",bg="#adf7b6",command=update_selected_items)
    ButterScotch.grid(row=0, column=10)

    # Rice
    Biryani = Radiobutton(dinnerNonveg, text="Biryani", font=("Arial", 10), indicatoron=0, variable=var10,value="Biryani",bg="#ffc09f", command=update_selected_items)
    Biryani.grid(row=0, column=0)
    ChickenCurry = Radiobutton(dinnerNonveg, text="ChickenCurry", font=("Arial", 10), indicatoron=0, variable=var10,value="ChickenCurry",bg="#a0ced9",command=update_selected_items)
    ChickenCurry.grid(row=0, column=5)
    ChickenFriedrice = Radiobutton(dinnerNonveg, text="Chickenfriedrice", font=("Arial", 10), indicatoron=0, variable=var10,value="Chickenfriedrice",bg="#adf7b6", command=update_selected_items)
    ChickenFriedrice.grid(row=0, column=10)

   #veg
    MushroomCurry = Radiobutton(dinnerVeg, text="MushroomCurry", font=("Arial", 10), indicatoron=0, variable=var11,value="MushroomCurry",bg="#ffc09f",command=update_selected_items)
    MushroomCurry.grid(row=0, column=0)
    AaloChana = Radiobutton(dinnerVeg, text="AaloChana", font=("Arial", 10), indicatoron=0, variable=var11,value="AaloChana",bg="#a0ced9", command=update_selected_items)
    AaloChana.grid(row=0, column=5)
    Paneer = Radiobutton(dinnerVeg, text="Paneer", font=("Arial", 10), indicatoron=0, variable=var11,value="Paneer",bg="#adf7b6", command=update_selected_items)
...
ico = Image.open(r"C:\Users\bhavana\Downloads\vishnuicon.png")
